...
public class TakeawayController implements Initializable {
    ...
    //Customer Details
    public Label firstNameLabelTakeaway;
    public Label lastNameLabelTakeaway;
    public Label addressLineLabelTakeaway;
    public Label postCoodeLabelTakeaway;
    public Label numberLabelTakeaway;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        staticNameLabel = firstNameLabelTakeaway;
        staticLastNameLabel = lastNameLabelTakeaway;
        staticAddressLineLabel = addressLineLabelTakeaway;
        staticPostCodeLabel = postCoodeLabelTakeaway;
        staticNumberLabel = numberLabelTakeaway;
    }
    ...
    public void compeleteOrderButtonClick(MouseEvent mouseEvent) throws IOException, SQLException {
        ...
        PreparedStatement listOfOrdersData = getConnection().prepareStatement("INSERT INTO `takeaway`(productName, productPrice) SELECT productName, productPrice FROM `customerorder` ");
        findMatchingData();
    ...
    public void receiptPrintingFunction() throws IOException, SQLException {
        ...
        try{
            ...
            writer.write("\n");
            writer.write("                  ########## ORDER TYPE: TAKEAWAY ##########");
            writer.write("\n");
            writer.write("+-----------------+--------------------+\n");
